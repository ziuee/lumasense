...
public class GuiRenameAlt extends GuiScreen
{
    ...
    public void drawScreen(final int par1, final int par2, final float par3) {
        ...
        ClientLoader.loaderInstance.fontManager.getFont("SFL 10").drawCenteredString("Edit Alt", this.width / 2, 10, -1);
        ClientLoader.loaderInstance.fontManager.getFont("SFL 10").drawCenteredString(this.status, this.width / 2, 20, -1);
