    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
            	Gui.drawRect(this.xPos - 1, this.yPos -1, this.xPos + this.width - 1, this.yPos + this.height + 1, 0x45000000);
                //Gui.drawRect(this.xPos - 1, this.yPos - 1, this.xPos + this.width - 60, this.yPos + this.height + 1, -6250336); // Background
