package me.luma.client.management.gui.material.components;
...
import me.luma.client.management.gui.clickgui.ClickGui;
...
public class Frame {
	...
	public Frame(Category cat) {
		...
		for(Module mod : ClientLoader.loaderInstance.moduleManager.getModulesInCategory(category)) {
	...
	public void renderFrame(FontRenderer fontRenderer) {
		Gui.drawRect(this.x, this.y, this.x + this.width, this.y + this.barHeight, ClickGuiMeterial.color);
		GL11.glPushMatrix();
