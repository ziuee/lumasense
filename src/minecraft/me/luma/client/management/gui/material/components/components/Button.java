package me.luma.client.management.gui.material.components.components;
...
import me.luma.client.management.gui.material.components.components.sub.Checkbox;
import me.luma.client.management.gui.material.components.components.sub.Keybind;
import me.luma.client.management.gui.material.components.components.sub.ModeButton;
import me.luma.client.management.gui.material.components.components.sub.Slider;
...
public class Button extends Component {
	...
	public Button(Module mod, Frame parent, int offset) {
		...
		height = 12;
		int opY = offset + 12;
		/*if(ClientLoader.loaderInstance.settingsManager.getSettingsByMod(mod) != null) {
	...
	public void renderComponent() {
		...
		if(this.open) {
			if(!this.subcomponents.isEmpty()) {
				...
				Gui.drawRect(parent.getX() + 2, parent.getY() + this.offset + 12, parent.getX() + 3, parent.getY() + this.offset + ((this.subcomponents.size() + 1) * 12), ClickGuiMeterial.color);
			}
		}
	}
