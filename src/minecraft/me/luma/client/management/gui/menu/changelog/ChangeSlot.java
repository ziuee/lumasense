...
public class ChangeSlot extends GuiSlot {
    ...
    protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
        ...
        ClientLoader.loaderInstance.fontManager.getFont("SFL 10").drawStringWithShadow(change.getType().toString(), p_180791_2_ + 2, p_180791_3_ + 2, getColor(change));
        ClientLoader.loaderInstance.fontManager.getFont("SFL 10").drawStringWithShadow(change.getLabel(), p_180791_2_ + 2, p_180791_3_ + 12, -1);
    }
