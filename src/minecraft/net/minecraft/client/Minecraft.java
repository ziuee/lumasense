...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws Exception
    {
        ...
        ClientLoader.loaderInstance.startLuma();
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                ...
                inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("luma/mainmenu/logo16.png"));
                inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("luma/mainmenu/logo32.png"));
    ...
    public void shutdownMinecraftApplet()
    {
        try
        {
        	ClientLoader.loaderInstance.shutdownLuma();
