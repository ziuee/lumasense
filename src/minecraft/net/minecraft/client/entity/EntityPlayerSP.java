...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        {
        	EventUpdate eventUpdate = new EventUpdate(this.rotationYaw, this.rotationPitch, this.getEntityBoundingBox().minY, this.onGround, true);
            eventUpdate.call();
    ...
    public void onUpdateWalkingPlayer()
    {
    	...
    	oldyaw = rotationYaw;
        rotationPitch = eventPreMotionUpdate.getPitch();
    	rotationYaw = eventPreMotionUpdate.getYaw();
    ...
    {
    	if(ClientLoader.onSendChatMessage(message)) {
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !ClientLoader.loaderInstance.moduleManager.getModule("NoSlowdown").isToggled() && !this.isRiding()) {
