...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        ClientLoader.loaderInstance.hud.drawPotions();
        ClientLoader.loaderInstance.hud.clientInfo();
        ClientLoader.loaderInstance.hud.ArrayList();
        
        NotificationManager notificationManager = ClientLoader.loaderInstance.notificationManager;
        NotificationManager.notificationUpdate();
        
        //Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Temp X: " + ClickGui.tempX, 7, 50, -1);
        //Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Temp Y: " + ClickGui.tempY, 7, 60, -1);
