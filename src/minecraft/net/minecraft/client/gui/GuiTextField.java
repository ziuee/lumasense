...
public class GuiTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
            	Gui.drawRect(this.xPosition - 1, this.yPosition -1, this.xPosition + this.width - 1, this.yPosition + this.height + 1, 0x45000000);
                //drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width - 60, this.yPosition + this.height + 1, -6250336); // Background
