    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn)
    {
        ...
        if(ClientLoader.loaderInstance.moduleManager.getModule("KillAura").isToggled()) {
        	if(Minecraft.getMinecraft().thePlayer != null) {
	            if(entityIn instanceof EntityPlayer && entityIn == Minecraft.getMinecraft().thePlayer) {
	            	this.bipedHead.rotateAngleX = Minecraft.getMinecraft().thePlayer.lastReportedPitch / (100 / (float) Math.PI) / 2;
	            }
	        }
        }
        
        if(ClientLoader.loaderInstance.moduleManager.getModule("Scaffold").isToggled()) {
        	if(Minecraft.getMinecraft().thePlayer != null) {
	            if(entityIn instanceof EntityPlayer && entityIn == Minecraft.getMinecraft().thePlayer) {
	            	this.bipedHead.rotateAngleX = Minecraft.getMinecraft().thePlayer.lastReportedPitch / (100 / (float) Math.PI) / 2;
	            }
