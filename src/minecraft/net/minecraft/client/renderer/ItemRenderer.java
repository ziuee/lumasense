...
import me.luma.client.management.module.impl.render.Animations;
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                    	if(Animations.animationsMode.getArraListValue().equalsIgnoreCase("Astolfo")) {
                            ...
                            if (this.timerUtil.hasElapsed(1L)) {
                                for (int i = 0; i < 2; i++) {
                                    ++this.delay;
                                }
                    	...
                    	if(Animations.animationsMode.getArraListValue().equalsIgnoreCase("Remix")) {
                            ...
                            GlStateManager.rotate(-var10 * (float) 50.0 / 2.0f, -8.0f, 0.4f, 9.0f);
                            GlStateManager.rotate(-var10 * (float) 40, 1.5f, -0.4f, -0.0f);
                            break;
                    	}
                    	
                    	if(Animations.animationsMode.getArraListValue().equalsIgnoreCase("1.7")) {
