...
public abstract class Render<T extends Entity>
{
    ...
    {
    	if(ClientLoader.loaderInstance.moduleManager.getModule("NameTags").isToggled() || (ClientLoader.loaderInstance.moduleManager.getModule("ESP").isToggled() && ESP.nametags.getBooleanValue())) {
    		return;
    	}
