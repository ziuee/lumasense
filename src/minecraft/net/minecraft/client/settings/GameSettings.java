...
public class GameSettings
{
    ...
    public KeyBinding LUMA_GUI_MOD_POS = new KeyBinding("HudMod Positioning", Keyboard.KEY_Y, "Luma");
    ...
    private void addLumaKeybinds() {
    	this.keyBindings = ((KeyBinding[])ArrayUtils.add(this.keyBindings, this.LUMA_GUI_MOD_POS));
	}
