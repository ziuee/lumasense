...
import me.luma.client.management.module.impl.render.TimeChanger;
...
public class WorldInfo
{
    ...
    {
        return (long) (ClientLoader.loaderInstance.moduleManager.getModule("TimeChanger").isToggled() ? (TimeChanger.time.getSliderValue().doubleValue()) : this.worldTime);
    }
